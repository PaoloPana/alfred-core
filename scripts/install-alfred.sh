...
create_default_config() {
    ...
    BASE_LINK="https://github.com/PaoloPana/alfred-core/raw/refs/tags/${LATEST_VERSION}"
...
ALFRED_LINK="https://github.com/PaoloPana/alfred-core/releases/download/${LATEST_VERSION}/alfred-core_${ARCH}.tar.gz"
